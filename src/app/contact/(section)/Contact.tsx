  ...
  return (
    ...
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
          ...
          <div className="flex w-full flex-col gap-8 bg-[#fff] px-6 lg:w-1/2 lg:px-28">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="tel:+07429939565" className="text-[#323232]">
                    07429 939565
                  </Link>
                </div>
              </div>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="h-full">
                          ...
                          <FormItem className="w-full">
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                className="h-12 rounded-xl bg-[#323232] text-[#fff] placeholder:text-white"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                          ...
                          <FormItem className="w-full">
                            ...
                            <FormControl>
                              <Textarea
                                ...
                                {...field}
                                className="h-32 rounded-xl bg-[#323232] text-[#fff] placeholder:text-white"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                  ...
                  <div className="flex w-full flex-col pt-7 lg:flex-row">
                    <Button
                      className="font-bai w-full rounded-2xl bg-[#C0A58A] py-6 text-white hover:bg-[#e7c9ac] hover:text-[#fff]"
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2251.9213669865376!2d-2.4257751!3d53.5730346!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487ba7933543f187%3A0xf4ffad8b5124257a!2sA%20R%20A%20Bakery!5e1!3m2!1sen!2sin!4v1743600944047!5m2!1sen!2sin"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
